---
title: How to get the infomation about an npm package
---

import Language from "../../components/PostHelpers/Language"

# How to get the infomation about an npm package

<Language type="zh" path="./how-to-get-a-npm-package-infomation" />
...
For example, Fetching `next` package infomation with the URL https://registry.npmjs.org/next/latest, and this is the simple result
...
Getting infomation by fetching Github document like a web crawler.

This method does not support [cross-domain](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS).
...
PDJ has a [Web App](https://package.json.taterbomb.top/)) and also a Chrome extension. The Chrome extension supports checking the package.json on a github page to display the above mentioned information.
