...
PDJ has a [Web App](https://package.json.taterbomb.top/) and also a [Chrome extension](https://chrome.google.com/webstore/detail/pdj/edgpjjbejcjkgnlnehoballnhokglenj). The Chrome extension supports checking the package.json on a github page to display the above mentioned information.
