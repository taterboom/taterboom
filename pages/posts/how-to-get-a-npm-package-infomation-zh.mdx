...
<Language path="./how-to-get-a-npm-package-infomation" type="en" />
...
PDJ 有一个[网页 App](https://package.json.taterbomb.top/))，也有一个 Chrome 扩展，Chrome 扩展支持在 github 页面上查阅 package.json 屏显示以上提到的信息。
